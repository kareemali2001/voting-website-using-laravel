...
class Condidate extends Component
{
    ...
    public function store()
    {
        ...
        $condidates->NationalID=$this->NationalID;
    ...
    public function edit($id)
    {
        ...
        $this->$edit_NationalID = $condidates->NationalID;
    ...
    public function update($id)
    {
        ...
        $this->validate([
            ...
            'edit_NationalID'=>['required','string'],
        ...
        $condidates->NationalID= $this->edit_NationalID;
