...
} elseif ($_instance->childHasBeenRendered('Er0xLRA')) {
    $componentId = $_instance->getRenderedChildComponentId('Er0xLRA');
    $componentTag = $_instance->getRenderedChildComponentTagName('Er0xLRA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Er0xLRA');
} else {
    $response = \Livewire\Livewire::mount('admin.logout');
    $html = $response->html();
    $_instance->logRenderedChild('Er0xLRA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </li>
...
<?php /**PATH C:\Users\DELL\vote project service\resources\views/layout/admin-app.blade.php ENDPATH**/ ?>